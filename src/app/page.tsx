...
import { BarChart, DollarSign, Package, Users2 as UsersIcon } from "lucide-react"; // Users2 is available, Users is not distinct enough
import Image from "next/image";

export default function DashboardPage() {
  return (
    <div className="flex flex-col gap-6">
      <h1 className="text-2xl md:text-3xl font-bold font-headline">Dashboard Overview</h1>
